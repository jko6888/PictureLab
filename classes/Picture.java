...
public class Picture extends SimplePicture 
{
  ...
  {
    {
      ...
      for (Pixel[] rowArray : pixels)
      {
        for (Pixel pixelObj : rowArray)
        {
          int average = (int)(pixelObj.getGreen() + pixelObj.getRed() + pixelObj.getBlue() / 3);
  ...
  public void createCollage()
  {
    ...
    this.secondCopy(flower1,0,100, 0, 100);
    int mirrorPoint = 98;
    Pixel rightPixel = null;
    Pixel leftPixel = null;
    Pixel[][] pixels = this.getPixels2D();
    ...
    this.secondCopy(flowerNoBlue,300,350,80,500);

    Picture flowerinverse = new Picture(flower2);
    flowerinverse.invert();
    this.secondCopy(flowerinverse, 100, 300, 80, 300);
  ...
  {
    Picture flower1 = new Picture("flower1.jpg");
    this.secondCopy(flower1,10,20, 0, 100);
